...
console.assert(obj1.current.second === 'bye!', 'Test 1'); // write this line
obj2.currentEntry = 'second';
console.assert(obj2.current.second === 'bye!', 'Test 2');

obj1.setCurrentEntry('first');
console.assert(obj1.current.first === 'hi!', 'Test 3');
console.assert(obj1.current.hasOwnProperty('second') === false, 'Test 4'); // write this line
obj2.currentEntry = 'first';
...
console.assert(obj1.current.hasOwnProperty('first') === false, 'Test 8'); // write this line

obj2.currentEntry = 'hi';
